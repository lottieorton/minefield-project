...
describe('Nav component', () => {    
    it('Renders the navigation links and Minesweep icon', () => {
        ...
        expect(screen.getByText(`Start a game 2`)).toBeInTheDocument();
    ...
    it('Links you to the correct location', () => {
        ...
        const startGameLink2 = screen.getByRole('link', { name: `Start a game 2` });
        ...
        expect(startGameLink2).toHaveAttribute('href', '/game');
