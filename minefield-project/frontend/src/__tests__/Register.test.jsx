...
describe("handleChange", () => {
  ...
  it.each([
    {
      formField: /username/i,
      input: "test username",
      expected: "test username",
    },
    {
      formField: /password/i,
      input: "test password",
      expected: "test password",
    },
    {
      formField: /first name/i,
      input: "test first name",
      expected: "test first name",
    },
    {
      formField: /last name/i,
      input: "test last name",
      expected: "test last name",
    },
  ])(
    "updates the values shown on screen when form fields are updated, via the state",
    async ({ formField, input, expected }) => {
      //arrange
      render(
        <MemoryRouter>
          <Register />
...
describe("handleSubmit", () => {
  ...
  it("renders success message if response.ok and form fields back to blank", async () => {
    ...
    const successMessage = screen.getByText(
      `Success! Account created for usernameMe. Redirecting to login...`,
    );
  ...
  it("for username taken renders specific error message", async () => {
    ...
    const errorMessage = screen.getByText(
      `The username "usernameMe" is already taken. Please choose another one.`,
    );
...
describe("Register component", () => {
  it("Renders the default Registration form", () => {
    ...
    const loginLink = screen.getByRole("link", {
      name: /already registered or want to Login with Google\? Login here./i,
    });
