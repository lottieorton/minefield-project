...
jest.mock("../components/functions/saveGame.js", () => ({
  saveGame: jest.fn(),
}));
    ...
    mockGameBoardComponent.mockImplementation((props) => (
      <div data-testid="mock-game-board">
        <span data-testid="mock-props">
          RowProp: {props.boardRows} | ColProp: {props.boardCols} |
          PlayingBoardProp: {String(props.playingGameBoard)} | CellClickProp:{" "}
          {props.onCellClick} | GameOverProp: {String(props.gameOver)} |
          GameWonProp: {String(props.gameWon)}
        </span>
        <button
          data-testid="mock-mine-click"
          onClick={() => props.onCellClick(0, 0)}
        >
          Click Mine
        </button>
        <button
          data-testid="mock-cell-0-1-click"
          onClick={() => props.onCellClick(0, 1)}
        >
          Click Cell 0-1
        </button>
        <button
          data-testid="mock-cell-1-0-click"
          onClick={() => props.onCellClick(1, 0)}
        >
          Click Cell 1-0
        </button>
        <button
          data-testid="mock-cell-1-1-click"
          onClick={() => props.onCellClick(1, 1)}
        >
          Click Cell 1-1
        </button>
      </div>
  ...
  it("if a 0 is clicked, all 0s and surrounding cells are recursively uncovered", async () => {
    ...
    mockGameBoardComponent.mockImplementation((props) => (
      <div data-testid="mock-game-board">
        ...
        <button
          data-testid="mock-cell-0-0-click"
          onClick={() => props.onCellClick(0, 0)}
        >
          Click Cell 0-0
        </button>
        <button
          data-testid="mock-mine-1-click"
          onClick={() => props.onCellClick(0, 1)}
        >
          Click Mine 1
        </button>
        <button
          data-testid="mock-cell-0-2-click"
          onClick={() => props.onCellClick(0, 2)}
        >
          Click Cell 0-2
        </button>
        <button
          data-testid="mock-cell-0-3-click"
          onClick={() => props.onCellClick(0, 3)}
        >
          Click Cell 0-3
        </button>
        <button
          data-testid="mock-mine-2-click"
          onClick={() => props.onCellClick(1, 0)}
        >
          Click Mine 2
        </button>
        ...
        <button
          data-testid="mock-cell-1-2-click"
          onClick={() => props.onCellClick(1, 2)}
        >
          Click Cell 1-2
        </button>
        <button
          data-testid="mock-cell-1-3-click"
          onClick={() => props.onCellClick(1, 3)}
        >
          Click Cell 1-3
        </button>
        <button
          data-testid="mock-cell-2-0-click"
          onClick={() => props.onCellClick(2, 0)}
        >
          Click Cell 2-0
        </button>
        <button
          data-testid="mock-cell-2-1-click"
          onClick={() => props.onCellClick(2, 1)}
        >
          Click Cell 2-1
        </button>
        <button
          data-testid="mock-cell-2-2-click"
          onClick={() => props.onCellClick(2, 2)}
        >
          Click Cell 2-2
        </button>
        <button
          data-testid="mock-cell-2-3-click"
          onClick={() => props.onCellClick(2, 3)}
        >
          Click Cell 2-3
        </button>
        <button
          data-testid="mock-cell-3-0-click"
          onClick={() => props.onCellClick(3, 0)}
        >
          Click Cell 3-0
        </button>
        <button
          data-testid="mock-cell-3-1-click"
          onClick={() => props.onCellClick(3, 1)}
        >
          Click Cell 3-1
        </button>
        <button
          data-testid="mock-cell-3-2-click"
          onClick={() => props.onCellClick(3, 2)}
        >
          Click Cell 3-2
        </button>
        <button
          data-testid="mock-cell-3-3-click"
          onClick={() => props.onCellClick(3, 3)}
        >
          Click Cell 3-3
        </button>
      </div>
    ...
    expect(gameBoard).toHaveTextContent(
      "PlayingBoardProp: ,,1,0,,2,1,0,1,1,0,0,0,0,0,0",
    );
  });
});
