...
describe("GameBoard component", () => {
  ...
  it("prints message if gameOver", () => {
    ...
    //assert
    expect(
      screen.queryByText(/Congrats, you discovered all the mines!/i),
  ...
  it("prints message if GameWon", () => {
    ...
    //assert
    expect(
      screen.getByText(/Congrats, you discovered all the mines!/i),
    ).toBeInTheDocument();
    expect(
      screen.queryByText(/Unfortunate, good try!/i),
    ).not.toBeInTheDocument();
  });
});
